chain(ucdavis_cctv, [
   ...
   service(feature_extr1, 5, 2, [], and(iot_data_encryption, and(anti_tampering, or(obfuscated_storage, encrypted_storage)))).
   ...
   maxLatency([cctv_driver1, feature_extr1, lightweight_analytics, alarm_driver1], 150).
